...
const graphqlSchemav2 = require('./schemav2');
const graphqlResolversv2 = require('./resolversv2');
...
module.exports = {
    createEndpoint: function (app, rootEndpoint, userData, schemaData) {
        ...
        const schema = buildSchema(graphqlSchemav2.generate(schemaData));
        const rootValue = graphqlResolversv2.generate(schemaData);
