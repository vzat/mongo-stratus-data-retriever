...
module.exports = {
    generate: function (json) {
        ...
        let resolvers = {};
        let context;
        resolvers['collection'] = function(args, context) {
            // Context is the req use it to get Authorization and other data
            console.log(context.get('Authorization'));
            // The name argument is mandatory
            collectionName = args.name;
            // throw new Error("WHAT");
            // Use a generated endpoint instead of sending the database and username
            // There should be a unique endpoint for each database or each user
            return collectionResolvers;
        };

        // if (context.get('Authorization') != 'Bearer a123') {
