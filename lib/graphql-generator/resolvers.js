...
module.exports = {
    generate: function (json) {
        // Get collection list from schema
        // Find root fields necessary - Make a new function
        // Fetch data from db for the fields required - Maybe do this in the getResolvers function
        // Create resolvers using the db data - getResolvers
