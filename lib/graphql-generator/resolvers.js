        ...
        try {
            ...
            for (const collectionName in query) {
                ...
                resolvers[collectionNameGet] = function (args, context, reqFields) {
                    ...
                    const dataReq = {
                        serverName: utils.getServerFromUrl(context.originalUrl),
                ...
                resolvers[collectionNameInsert] = function (args, context) {
                    ...
                    let dbArgs = [];
                    for (const argNo in args.docs) {
                        const arg = args.docs[argNo];
                        dbArgs.push(getArgs(arg));
                    }
                    ...
                    return db.insertDocuments(dataReq, collectionName, dbArgs);
                };
                ...
                resolvers[collectionNameDelete] = function (args, context) {
                    ...
                    return db.deleteDocuments(dataReq, collectionName, dbArgs);
                };
                ...
                resolvers[collectionNameUpdate] = function (args, context) {
                    ...
                    return db.updateDocuments(dataReq, collectionName, filter, update);
                };
            }
